...
def get_number_of_environments_for_workload(factor=0.65):
    number_cpu_instances = int(psutil.cpu_count(logical=True)*((100 - psutil.cpu_percent(interval=5))/100)*factor)
