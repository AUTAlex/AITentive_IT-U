...
def __generateFileName(param):
    ...
    if ac == 'o' or full_vision:
        filename = "EnvA{}DP{}R{}A{}T{}TB{}.json".format(                   __get_identifier(search_multilevel_directory(param, "autonomous", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "decisionPeriod", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "resetPlatformToIdentity", ["supervisorSettings"])),
                                                                            ac,
                                                                            __get_identifier(search_multilevel_directory(param, "trainSupervisor", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "trainBallAgent", ["supervisorSettings"])))
    else:
        filename = "EnvF{}A{}DP{}R{}A{}T{}TB{}N{}NS{}S{}SM{}U{}O{}RT{}OD{}.json".format(__get_identifier(search_multilevel_directory(param, "useFocusAgent", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "autonomous", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "decisionPeriod", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "resetPlatformToIdentity", ["supervisorSettings"])),
                                                                            ac,
                                                                            __get_identifier(search_multilevel_directory(param, "trainSupervisor", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "trainBallAgent", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "numberOfBins", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "numberOfSamples", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "sigma", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "sigmaMean", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "updatePeriode", ["supervisorSettings"])), 
                                                                            __get_identifier(search_multilevel_directory(param, "observationProbability", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "constantReactionTime", ["supervisorSettings"])),
                                                                            __get_identifier(search_multilevel_directory(param, "oldDistributionPersistenceTime", ["supervisorSettings"])))

    return filename


def __get_identifier(value):
...
def search_multilevel_directory(directory, search_key, restricted_keys):
    def search_recursive(sub_directory, current_level):
        if current_level in restricted_keys:
            return None

        for key, value in sub_directory.items():
            if key == search_key:
                return value
