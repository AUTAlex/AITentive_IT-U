...
### Prerequisites
The Project uses Anaconda for open source python distribution. Goto https://www.anaconda.com/ for the installation. Unity can be downloaded at https://unity.com/download. Follow the instructions to install the Unity Hub and choose Unity editor version 6000.0.23f1.
...
```
conda env create -f config/AITentive.yaml
```

The environment can be activated by the following command:

```
conda activate AITentive
```
...
5. For details on how to perform hyperparameter optimization with Ray Tune, see the [Ray Tune: Hyperparameter Optimization](docs/Ray-Tune-HPO.md) page.
