...
public class HyperparametersBase : ISettings
{
    ...
    public bool? useAttentionTimer;
    public bool? useVisibilityTimer;
    public string? visualTaskQueueChoice;
    public string? visionAgentChoice;
    public string focusAgentModelName;
    public bool? saveBehavioralData;
    public bool? useVisionAgentPerTask;
    public bool? heuristicModeForVisionAgent;
    public bool? useConstantAspectRatio;
    ...
    public HyperparametersBase(HyperparametersBase hyperparametersBase)
    {
        ...
        this.visualTaskQueueChoice = hyperparametersBase.visualTaskQueueChoice;
        this.visionAgentChoice = hyperparametersBase.visionAgentChoice;
        this.useAttentionTimer = hyperparametersBase.useAttentionTimer;
        this.useVisionAgentPerTask = hyperparametersBase.useVisionAgentPerTask;
        this.heuristicModeForVisionAgent = hyperparametersBase.heuristicModeForVisionAgent;
        this.useConstantAspectRatio = hyperparametersBase.useConstantAspectRatio;
    }
...
public class JsonAgentSettings : JsonSettings, IAgentSettings
{
    ...
    public JsonAgentSettings(int version, Type type, Dictionary<string, string> fields, int? decisionPeriod, Type baseType) : base(version, type, fields)
    {
        this.decisionPeriod = decisionPeriod;
        //Debug.Log($"{type}.GetLowestBaseTypeInHierarchyOf({baseType})={type.GetLowestBaseTypeInHierarchyOf(baseType)}");
        this.baseClassName = type.GetLowestBaseTypeInHierarchyOf(baseType).Name;
    }
}
