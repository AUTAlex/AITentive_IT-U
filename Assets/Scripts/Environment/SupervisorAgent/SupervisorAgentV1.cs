...
namespace Supervisor
{
    ...
    public class SupervisorAgentV1 : SupervisorAgent
    {
        ...
        private int _activeInstanceActionLevel;

        private int _previousActiveActionLevel;
        ...
        protected override void PropagateTimeBetweenSwitches(int activeInstance, Switcher switcher)
        {
            InvokeOnTaskSwitchCompleted(activeInstance, switcher);
        ...
        protected override void SwitchAgentTo(int activeInstance, Switcher switcher)
        {
            UpdateAgentsActiveStatus(activeInstance, VisualizeActiveStatusOfTasks);
            //_switchCount += 1; <-- diff
            PropagateTimeBetweenSwitches(activeInstance, switcher);
        ...
        protected override void ForcedAction(int activeInstance)
        {
            ...
            if (_previousActiveActionLevel != _activeInstanceActionLevel)
            {
                ...
                {
                    SwitchAgentTo(_activeInstanceActionLevel, Switcher.Supervisor);
                }
