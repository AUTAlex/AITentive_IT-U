...
public class InspectorTests
{
    ...
    {
        List<(Component, FieldInfo)> projectAssignFields = ProjectManager.GetProjectAssignFieldsForSupervisor();
    ...
    {
        List<(Component, FieldInfo)> projectAssignFields = ProjectManager.GetProjectAssignFieldsForTaskPrefabs();
