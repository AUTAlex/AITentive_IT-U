...
## Next Step
The last stage involves comparing the behavioral measurements through distance calculation.  
The [User Study: Results and Setup](User-Study-Results-and-Setup.md) page demonstrates how this was done for ["Supporting Task Switching with Reinforcement Learning"](https://dl.acm.org/doi/10.1145/3613904.3642063).  
Additionally, the [Ray Tune: Hyperparameter Optimization](Ray-Tune-HPO.md) page describes how the repository supports automated hyperparameter optimization to further improve model performance.